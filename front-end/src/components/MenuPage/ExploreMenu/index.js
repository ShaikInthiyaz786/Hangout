...
const tabsList = [
  {tabId: 'MON', displayText: 'Mon'},
  {tabId: 'TUE', displayText: 'Tue'},
  {tabId: 'WED', displayText: 'Wed'},
  {tabId: 'THU', displayText: 'Thu'},
  {tabId: 'FRI', displayText: 'Fri'},
  {tabId: 'SAT', displayText: 'Sat'},
]
const imagesList = [
  {
...
class ExploreMenu extends Component {
  ...
  render() {
    const {isTrue, category} = this.state
